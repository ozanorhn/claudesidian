...
tags: [projekt, fitness, gesundheit]
---
...
- **Plan:** PPL (Push-Pull-Legs) bei FitX
- **Start:** Ernsthaft ab 30.03.2026
- **Details:** [[Training/PPL Trainingsplan]]

## Unterordner

- `Tracking/` – Fortschritt, Gewicht, Messungen
- `Training/` – Workouts und Pläne
- `Ernährung/` – Rezepte, Mahlzeitenpläne

## Nächste Schritte

- [ ] Ausgangswerte dokumentieren (Gewicht, Maße)
- [ ] Zielgewicht & Körperfettanteil festlegen
- [ ] Erstes ernsthaftes Training – 30.03.2026
- [ ] Supplements kaufen: K2 MK-7, Magnesium, Ashwagandha KSM-66
